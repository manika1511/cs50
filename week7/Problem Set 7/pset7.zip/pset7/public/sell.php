<?php
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $lookup_rows = CS50::query("SELECT * FROM `portfolio` WHERE id = ? AND symbol = ?", $_SESSION["id"], $_POST["sale_stock"]);
        ...
        CS50::query("DELETE FROM `portfolio` WHERE id = ? AND symbol = ?", $_SESSION["id"], $_POST["sale_stock"]);
